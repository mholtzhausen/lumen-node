...
impl LeftChromeWiring {
    pub(crate) fn new(header: &HeaderControls, tree: &TreeWidgets) -> Self {
        Self {
            ...
            favourites_filter_btn: header.favourites_filter_btn.clone(),
            tags_filter_btn: header.tags_filter_btn.clone(),
            tags_filter_list: header.tags_filter_list.clone(),
            search_entry: header.search_entry.clone(),
            clear_btn: header.clear_btn.clone(),
            similar_filter_btn: header.similar_filter_btn.clone(),
