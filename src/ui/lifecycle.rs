...
pub(crate) fn install_lifecycle(deps: LifecycleDeps) {
    ...
    install_close_persistence_handler(ClosePersistenceDeps {
        ...
        meta_section_expanded_pref: deps.right.meta_section_expanded_pref.clone(),
    ...
    restore_session_state(RestoreSessionDeps {
        ...
        meta_expander: deps.right.meta_expander,
        meta_split_before_auto_collapse: deps.right.meta_split_before_auto_collapse,
        meta_section_expanded_pref: deps.right.meta_section_expanded_pref,
